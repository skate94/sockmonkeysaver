...
.defines(function(){
    EntityPlayert = ig.Entity.extend({
        animSheet: new ig.AnimationSheet( 'media/top-sprite.png', 16, 16 ),
        size: {x: 8, y:14},
        offset: {x: 4, y: 2},
        flip: false,
        maxVel: {x: 100, y: 100},
        ...
        update: function() {
            ...
            }else if( this.vel.y > 0 ){//&& !(this.currentAnim == this.anims.climb1) && !(this.currentAnim == this.anims.climb2)) {
            	this.currentAnim = this.anims.run;
        ...
        onDeath: function(){
            ...
            if(ig.game.lives < 0){
                ...
                ig.game.spawnEntity( EntityPlayert, ig.game.respawnPosition.x, ig.game.respawnPosition.y);
            }
        },
